...
<body>
    <div class="container">
        ...
        <form method="post" action="signup.jsp">
            ...
            <input type="text" placeholder="이름을 입력해주세요" name="username" maxlength="4" required>

            <label for="nickname">닉네임</label>
            <input type="text" placeholder="닉네임을 입력해주세요" name="nickname" maxlength="7" required>

            <label for="_id">아이디</label>
            <input type="text" placeholder="아이디를 입력해주세요" name="_id" maxlength="20" required>

            <label for="password">비밀번호</label>
            <input type="password" placeholder="비밀번호를 입력하세요" name="password" maxlength="20" required>
            ...
            <input type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '')" maxlength="11" placeholder="휴대폰 번호" name="phoneNumber" required>
            <button type="submit" href=#><b>인증번호 발송</b></button>
            </div>
            ...
            <input type="email" id="email" placeholder="이메일을 입력해주세요" name="email" maxlength="30" required></form>

            <label for="birth">생년월일(주민등록번호 앞 6자리)</label>
            ...
            <button type="submit" href=#><b>SIGN UP</b></button>
